    ...
    >
      ...
      {variant === "billing" && (
        <>
          ...
          <rect x="96" y="100" width="120" height="12" rx="6" fill="#0F6B63" />
      ...
      {variant === "credentialing" && (
        <>
          ...
          <circle cx="200" cy="120" r="28" fill="#0F6B63" />
          <path d="M200 108v24M188 120h24" stroke="white" strokeWidth="3" strokeLinecap="round" />
          <rect x="120" y="168" width="160" height="10" rx="5" fill="#0F6B63" />
          ...
          <rect x="302" y="230" width="86" height="22" rx="11" fill="#0F6B63" />
        </>
      )}
      ...
      {variant === "mips" && (
        <>
          ...
          <rect x="96" y="98" width="140" height="12" rx="6" fill="#0F6B63" />
          ...
          <circle cx="345" cy="145" r="34" fill="#0F6B63" fillOpacity="0.12" />
          <circle
            cx="345"
            cy="145"
            r="26"
      ...
      {variant === "front-desk" && (
        <>
          ...
          <rect x="156" y="138" width="78" height="10" rx="5" fill="#0F6B63" />
          ...
          <rect x="276" y="100" width="118" height="12" rx="6" fill="#0F6B63" />
      ...
      {variant === "about" && (
        <>
          ...
          <circle cx="140" cy="150" r="30" fill="#0F6B63" />
          <circle cx="210" cy="150" r="30" fill="#1E88E5" />
          <circle cx="280" cy="150" r="30" fill="#2EC4B6" />
          <rect x="110" y="210" width="260" height="12" rx="6" fill="#0F6B63" />
      ...
      {variant === "digital-marketing" && (
        <>
          ...
          <rect x="80" y="104" width="110" height="10" rx="5" fill="#0F6B63" />
          ...
          <rect x="320" y="98" width="58" height="8" rx="4" fill="#0F6B63" />
